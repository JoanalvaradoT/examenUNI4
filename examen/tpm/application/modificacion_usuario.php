...
if (isset($_GET['id'])) {
  ...
  $usuario = $usuarioController->obtenerUsuario($_GET['id'])['data'];
...
<body data-pc-preset="preset-1" data-pc-sidebar-theme="light" data-pc-sidebar-caption="true" data-pc-direction="ltr"
  ...
  <div class="pc-container">
    ...
    <div class="pc-content">
      ...
      <form action="../../app/UsuarioController.php?action=update" method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="lastname" name="lastname"
            value="<?php echo htmlspecialchars($usuario['lastname']); ?>" required>
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="phone_number" name="phone_number"
            value="<?php echo htmlspecialchars($usuario['phone_number']); ?>" required>
        </div>

        <div class="mb-3">
          <label for="role" class="form-label">Rol</label>
          <input type="text" class="form-control" id="role" name="role"
            value="<?php echo htmlspecialchars($usuario['role']); ?>" required>
        </div>
